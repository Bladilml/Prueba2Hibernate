 ...
 * @author durib
 */
@WebServlet(name = "getProvinciaServlet", urlPatterns = {"/getProvinciaServlet.do"})
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            try (PrintWriter out = response.getWriter();){
                ...
                Logger.getLogger(getProvinciaServlet.class.getName()).log(Level.SEVERE,"Error en printLn! {0}",ex.toString());
            }
        }catch(NumberFormatException ex){
           Logger.getLogger(getProvinciaServlet.class.getName()).log(Level.SEVERE,"Id de region presenta error! {0}",ex.toString()); 
        }
